  ...
  return (
    <aside data-sidebar="1" style={css('width:264px;flex:none;background:#FFFDF6;border-right:3px solid #2B2336;display:flex;flex-direction:column;position:sticky;top:0;height:100vh')}>
      ...
      <nav style={css('padding:12px 10px;display:flex;flex-direction:column;gap:5px')}>
        ...
        {v.nav.map(item => (
          <Sx key={item.id} as="button" onClick={item.go}
            ...
            hover="transform:translate(-1px,-1px);box-shadow:3px 3px 0 #2B2336;border-color:#2B2336"
      ...
      <div style={css('margin-top:auto;padding:14px;display:flex;flex-direction:column;gap:12px')}>
        <div style={css('border:3px solid #2B2336;border-radius:14px;background:#FFF;box-shadow:4px 4px 0 #2B2336;padding:13px 14px')}>
          ...
          <div style={css('display:flex;align-items:baseline;gap:5px;margin-bottom:8px')}>
            <span style={css("font-family:'Space Grotesk',sans-serif;font-size:22px;font-weight:700;letter-spacing:-.6px")}>742</span>
            <span style={css('font-size:12px;font-weight:700;color:#6F687A')}>/ 1000</span>
          </div>
          <div style={css('height:11px;border:2px solid #2B2336;border-radius:999px;background:#FFF8E7;overflow:hidden')}>
            <div style={css('width:74.2%;height:100%;background:repeating-linear-gradient(45deg,#B7F34A 0 7px,#9FE034 7px 14px)')}></div>
          </div>
        ...
        <Sx as="button"
          ...
          hover="border-color:#2B2336;background:#FFF">
          ...
          <span style={css('flex:1;min-width:0')}>
            <span style={css('display:block;font-size:12.5px;font-weight:700')}>Aarav Rao</span>
            <span style={css('display:block;font-size:10.5px;color:#6F687A;font-weight:600')}>PRO · unlimited doubt</span>
          </span>
