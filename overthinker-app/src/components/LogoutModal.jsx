...
export default function LogoutModal(v) {
  return (
    <div style={css('position:fixed;inset:0;z-index:60;background:rgba(43,35,54,.55);display:flex;align-items:center;justify-content:center;padding:18px')}>
      <div style={css('width:100%;max-width:460px;background:#FFF;border:4px solid #2B2336;border-radius:22px;box-shadow:9px 9px 0 #2B2336;animation:ot-pop .28s cubic-bezier(.2,.9,.3,1.1) both;overflow:hidden')}>
        <div style={css('padding:16px 20px;border-bottom:3px solid #2B2336;background:#FF4D4D')}>
          <span style={css('font-family:Bangers,cursive;font-size:26px;letter-spacing:1px;color:#FFF')}>ARE YOU SURE?</span>
        </div>
