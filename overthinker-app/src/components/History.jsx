    ...
    <div style={css('max-width:1240px;margin:0 auto;display:flex;flex-direction:column;gap:18px')}>
      ...
      <div style={css('display:flex;flex-wrap:wrap;gap:10px;align-items:center')}>
        ...
        <div style={css('flex:1;min-width:210px;display:flex;align-items:center;gap:9px;padding:10px 13px;border:3px solid #2B2336;background:#FFF;border-radius:14px;box-shadow:3px 3px 0 #2B2336')}>
          <svg width="14" height="14" viewBox="0 0 14 14" fill="none"><circle cx="6" cy="6" r="4.3" stroke="#2B2336" strokeWidth="2"></circle><path d="M9.3 9.3 12.5 12.5" stroke="#2B2336" strokeWidth="2" strokeLinecap="round"></path></svg>
          <input value={v.search} onChange={v.onSearch} placeholder="Search your regrets…" style={css('flex:1;border:0;outline:none;background:transparent;color:#1A1720;font-size:13px;font-weight:600')} />
        </div>
        <span style={css('font:700 11px Inter,sans-serif;color:#6F687A')}>{v.rowCount} REGRETS</span>
      </div>

      <div style={css('background:#FFF;border:3px solid #2B2336;border-radius:18px;overflow:hidden;box-shadow:6px 6px 0 #2B2336')}>
        ...
        {v.noRows && (
          <div style={css('padding:60px 24px;text-align:center')}>
            ...
            <div style={css('font-family:Bangers,cursive;font-size:30px;letter-spacing:1px;color:#2B2336')}>WOW. NO OVERTHINKING HISTORY.</div>
            <div style={css('font-size:14px;color:#6F687A;margin-top:8px;font-weight:600')}>Are you okay?</div>
      ...
      <div style={css('background:#FF4D4D;border:3px solid #2B2336;border-radius:18px;padding:18px 20px;box-shadow:6px 6px 0 #2B2336;display:flex;flex-wrap:wrap;gap:16px;align-items:center')}>
        <div style={css('flex:1;min-width:240px')}>
          ...
          <div style={css('font-size:13px;color:#FFF;font-weight:600;margin-top:7px')}>The AI agents have entered an unnecessary disagreement. Decision engine emotionally unavailable.</div>
        </div>
