...
def create_app(settings_override: Settings | None = None, store_override=None, provider_override=None) -> FastAPI:
    ...
    async def lifespan(app: FastAPI):
        ...
        elif cfg.ai_provider=="gemini": provider=GeminiProvider(_required_key(cfg.gemini_api_key,"gemini","GEMINI_API_KEY"),cfg.gemini_model,cfg.gemini_judge_model,fallback_model=cfg.gemini_model_pool,max_concurrency=cfg.gemini_max_concurrency)
